...
export declare const getL1Bridge: (wallet: Wallet, AddressManager: Contract) => Promise<Contract>;
export declare const getL2Bridge: (wallet: Wallet) => Promise<Contract>;
